.name "lockpatch_blus30187"
.hook 0x932f60 ENT933060 #detect single lock problem A
.hook 0x932f7c ENT93307c #detect single lock problem B
.hook 0x933310 ENT933410 #save enemy pointer A
.hook 0x9333a8 ENT9334a8 #save enemy pointer B
.hook 0x9799f0 ENT979b00 #reset value
.hook 0x9793dc ENT9794ec #detect memory address and make ring buffer
.hook 0x974f74 ENT975084 #load enemy pointer A
.hook 0x97503c ENT97514c #load enemy pointer B
