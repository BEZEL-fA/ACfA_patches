.name "lockpatch_bljm60066"
.hook 0x933060 ENT933060 #detect single lock problem A
.hook 0x93307c ENT93307c #detect single lock problem B
.hook 0x933410 ENT933410 #save enemy pointer A
.hook 0x9334a8 ENT9334a8 #save enemy pointer B
.hook 0x979b00 ENT979b00 #reset value
.hook 0x9794ec ENT9794ec #detect memory address and make ring buffer
.hook 0x975084 ENT975084 #load enemy pointer A
.hook 0x97514c ENT97514c #load enemy pointer B
